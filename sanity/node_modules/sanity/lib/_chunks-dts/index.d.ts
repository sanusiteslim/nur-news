...
declare const structureLocaleStrings: {
  ...
  'banners.variant.waiting.description': string; /** Title of toast that will appear while the document is added to the variant */
  'banners.variant.waiting.title': string; /** Browser/tab title when creating a new document of a given type */
  ...
  'document-view.form-view.sync-lock-toast.title': string; /** Description of the toast shown when recent edits haven't synced for a while (still retrying) */
  'document-view.form-view.sync-pending.description': string; /** Title of the toast shown when recent edits haven't synced for a while (still retrying) */
  'document-view.form-view.sync-pending.title': string; /** Description of the toast shown when the connection is back and buffered edits are being submitted */
  'document-view.form-view.sync-recovering.description': string; /** Title of the toast shown when the connection is back and buffered edits are being submitted */
  'document-view.form-view.sync-recovering.title': string; /** Description of the toast shown when edits have been unsynced long enough that editing is locked */
  'document-view.form-view.sync-stalled.description': string; /** Title of the toast shown when edits have been unsynced long enough that editing is locked */
  'document-view.form-view.sync-stalled.title': string; /** The description for the document favorite action */
