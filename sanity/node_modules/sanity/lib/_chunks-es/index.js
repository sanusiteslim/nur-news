...
import { Button as Button$1, Flex, Box, Text, Dialog as Dialog$1, ErrorBoundary as ErrorBoundary$1, MenuButton as MenuButton$1, Hotkeys as Hotkeys$1, Tooltip as Tooltip$1, Badge, MenuItem as MenuItem$1, Stack, Popover as Popover$1, Tab as Tab$1, TooltipDelayGroupProvider as TooltipDelayGroupProvider$1 } from "@sanity/ui";
...
const LARGE_BUTTON_PROPS = {
  ...
  space: 2,
  padding: 2
}, TooltipButtonWrapper = /* @__PURE__ */ styled.span.withConfig({
  ...
  let t3;
  $[8] !== footer || $[9] !== props || $[10] !== t ? (t3 = (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxs(Flex, { gap: 3, justify: "flex-end", padding: 3, align: "center", children: [
...
}), FONT_SIZE = 1, SUBTITLE_FONT_SIZE = 0, SubtitleText = /* @__PURE__ */ styled(Text).withConfig({
  displayName: "SubtitleText",
  componentId: "sc-1sm0vyt-0"
})(["margin-top:2px;"]), PreviewWrapper = /* @__PURE__ */ styled(Box).withConfig({
