...
export async function transpileFunction(resource, { installer } = {}) {
    ...
    try {
        ...
        await cleanupTmpDir();
        throw new Error(`Transpiling of function failed: ${formatBuildError(err)}`, {
            cause: err,
        });
    }
}
