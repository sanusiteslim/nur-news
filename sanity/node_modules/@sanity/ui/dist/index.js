...
let react_compiler_runtime = require("react-compiler-runtime"), _sanity_icons = require("@sanity/icons"), react = require("react"), react_is = require("react-is");
...
const StyledCheckbox = /* @__PURE__ */ styled_components.styled.div.withConfig({
	...
	let t7;
	$[20] === Symbol.for("react.memo_cache_sentinel") ? (t7 = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_sanity_icons.CheckmarkIcon, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_sanity_icons.RemoveIcon, {})] }), $[20] = t7) : t7 = $[20];
	let t8;
...
const selectStyle = {
	...
	let t12;
	$[29] === Symbol.for("react.memo_cache_sentinel") ? (t12 = /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_sanity_icons.ChevronDownIcon, {}), $[29] = t12) : t12 = $[29];
	let t13;
...
const StyledTextArea = /* @__PURE__ */ styled_components.styled.span.withConfig({
	...
	let border = t0 === void 0 ? !0 : t0, disabled = t1 === void 0 ? !1 : t1, fontSize = t2 === void 0 ? 2 : t2, padding = t3 === void 0 ? 3 : t3, radius = t4 === void 0 ? 2 : t4, ref = (0, react.useRef)(null), rootTheme = require_tabList.at(), t5;
...
})`& > ul{list-style:none;padding:0;margin:0;}`, rotate = styled_components.keyframes`from{transform:rotate(0deg);}to{transform:rotate(360deg);}`, AnimatedSpinnerIcon = (0, styled_components.styled)(_sanity_icons.SpinnerIcon).withConfig({
...
const AUTOCOMPLETE_LISTBOX_IGNORE_KEYS = [
	...
	let border = t0 === void 0 ? !0 : t0, fontSize = t1 === void 0 ? 2 : t1, listBox = t2 === void 0 ? require_tabList.Tt : t2, paddingProp = t3 === void 0 ? 3 : t3, popover = t4 === void 0 ? require_tabList.Tt : t4, radius = t5 === void 0 ? 2 : t5, renderValue = t6 === void 0 ? DEFAULT_RENDER_VALUE : t6, t7 = valueProp || null, t8 = valueProp || null, t9;
	$[30] !== t7 || $[31] !== t8 ? (t9 = {
		activeValue: t7,
		focused: !1,
		listFocused: !1,
	...
	$[98] !== disabled || $[99] !== expanded || $[100] !== fontSize || $[101] !== handleOpenClick || $[102] !== openButton || $[103] !== openButtonBoxPadding || $[104] !== openButtonPadding || $[105] !== openButtonProps || $[106] !== readOnly ? (t37 = !disabled && !readOnly && openButton ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_tabList.W, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_tabList.z, {
			...
			disabled: expanded,
			fontSize,
			icon: _sanity_icons.ChevronDownIcon,
			mode: "bleed",
...
function isTargetWithinScope(boundaryElement, portalElement, target) {
	return !boundaryElement || !portalElement ? !0 : require_tabList._t(boundaryElement, target) || require_tabList._t(portalElement, target);
}
...
const animation = styled_components.css`background-image:linear-gradient( to right,var(--card-skeleton-color-from),var(--card-skeleton-color-to),var(--card-skeleton-color-from),var(--card-skeleton-color-from),var(--card-skeleton-color-from) );background-position:100%;background-size:200% 100%;background-attachment:fixed;animation-name:${styled_components.keyframes`0%{background-position:100%;}100%{background-position:-100%;}`};animation-timing-function:ease-in-out;animation-iteration-count:infinite;animation-duration:2000ms;`, skeletonStyle = styled_components.css`opacity:${({ $visible }) => +!!$visible};transition:opacity 200ms ease-in;@media screen and (prefers-reduced-motion:no-preference){${({ $animated }) => $animated ? animation : styled_components.css`background-color:var(--card-skeleton-color-from);`}}@media screen and (prefers-reduced-motion:reduce){background-color:var(--card-skeleton-color-from);}`, StyledSkeleton$1 = /* @__PURE__ */ (0, styled_components.styled)(require_tabList.W).withConfig({
	...
	let animated = t0 === void 0 ? !1 : t0, [visible, setVisible] = (0, react.useState)(!delay), t1, t2;
...
function TreeItem(props) {
	...
	let expandedProp = t0 === void 0 ? !1 : t0, fontSize = t1 === void 0 ? 1 : t1, padding = t2 === void 0 ? 2 : t2, selected = t3 === void 0 ? !1 : t3, spacing = gap === void 0 ? t4 === void 0 ? 2 : t4 : gap, [rootElement, _setRootElement] = (0, react.useState)(null), t5;
	...
	$[53] !== IconComponent || $[54] !== expanded || $[55] !== fontSize || $[56] !== muted || $[57] !== weight ? (t18 = !IconComponent && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToggleArrowText, {
		...
		size: fontSize,
		weight,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_sanity_icons.ToggleArrowRightIcon, { style: { transform: expanded ? "rotate(90deg)" : void 0 } })
