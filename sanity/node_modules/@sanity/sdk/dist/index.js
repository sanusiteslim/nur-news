...
function applySingleDocPatch({
  ...
  const baseAfter = base[documentId], diffedPatches = preserveOperations ? patches : diffValue(baseBefore, baseAfter), workingBefore = working[documentId];
...
function handleEdit(action, ctx) {
  ...
  const baseAfter = base[patchDocumentId], patches = action.preserveOperations ? action.patches ?? [] : diffValue(baseBefore, baseAfter), workingMutations = [];
