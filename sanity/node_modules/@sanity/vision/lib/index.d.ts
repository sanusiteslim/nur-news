...
declare const visionLocaleStrings: {
  ...
  readonly 'action.save-personal-copy': 'Save personal copy'; /** Label for saving a personal query */
  readonly 'action.save-personal-query': 'Save as personal'; /** Label for saving a query */
  readonly 'action.save-query': 'Save query'; /** Label for saving a shared query */
  readonly 'action.save-shared-query': 'Save as shared'; /** Label for unsharing a query */
  readonly 'action.unshare': 'Unshare'; /** Label for updating a query */
  readonly 'action.update': 'Update'; /** Label for actions user can take */
  readonly 'label.actions': 'Actions'; /** Label for all saved queries */
  readonly 'label.all': 'All'; /** Label for saved queries that have been edited */
  ...
  readonly 'label.share': 'Share'; /** Label for query type "shared" */
  readonly 'label.shared': 'Shared'; /** Label for saved query type "team" */
  readonly 'label.team': 'Team'; /** Label for untitled query fallback */
  readonly 'label.untitled-query': 'Untitled'; /** Error message for when the "Params" input are not a valid json */
  ...
  readonly 'save-query.error': 'Error saving query'; /** Save personal copy success label */
  readonly 'save-query.personal-copy-success': 'Personal copy saved'; /** Warning displayed before sharing a query */
  readonly 'save-query.share-warning': 'Shared queries are stored as documents in your dataset and count toward your document quota.'; /** Save shared query success label */
  readonly 'save-query.shared-success': 'Shared query saved'; /** Save success label */
  readonly 'save-query.success': 'Query saved'; /** Save unshared query success label */
  readonly 'save-query.unshared-success': 'Query moved to personal'; /** Label for the "API version" dropdown in settings */
